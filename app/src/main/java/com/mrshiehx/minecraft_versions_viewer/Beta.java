...
public class Beta extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.initialization(this, R.string.activity_beta_name);
    ...
    DialogInterface.OnClickListener goToSettings = new DialogInterface.OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            startActivity(new Intent().setClass(Beta.this, Settings.class));
        }
    };
    ...
    public void initListview() {
        ...
        if (sharedPreferences.getString("beta_versions_source", "default").equals("default")) {
            ...
            if (TextUtils.isEmpty(sharedPreferences.getString("input_beta_versions_source", null)) == false) {
                if (Utils.isUrlAUrl(sharedPreferences.getString("input_beta_versions_source", null)) == true) {
                    String fileNameOfInputerVersionsSourceGetText = sharedPreferences.getString("input_beta_versions_source", null).substring(sharedPreferences.getString("input_beta_versions_source", null).lastIndexOf("/") + 1);
                    ...
                    if (fileExtensionOfInputerVersionsSourceGetText.equals("json") == true) {
                        try {
                            Utils.downloadAndInitListview(
                                    this,
                                    sharedPreferences.getString("input_beta_versions_source", null),
            ...
            if (TextUtils.isEmpty(sharedPreferences.getString("input_beta_versions_source", null)) == false) {
                String localFileName = sharedPreferences.getString("input_beta_versions_source", null).substring(sharedPreferences.getString("input_beta_versions_source", null).lastIndexOf("/") + 1);
                if (Utils.fileIsExists(this, sharedPreferences.getString("input_beta_versions_source", null)) == true) {
